...
ASC_2021_data_1=ASC_2021_data.loc[1:449,:]
...
plt.title('Cycle Number vs Heat Rate  - with 1 Heat Ramp', fontsize=10)
plt.ylabel('Heat Rate 1 [C/min]', fontsize=10)
plt.xlabel('Cycle Number', fontsize=10)
plt.grid(True)
plt.show()
plt.tight_layout()
plt.savefig('Heat Ramp 1 - Plots/Cycle Number vs Heat Rate  - with 1 Heat Ramp.png', dpi = 300)
# Ramp Duration
plt.figure(figsize=(6.5,4))
plt.scatter( ASC_2021_data_X['Cycle Number'],ASC_2021_data_X['Ramp 1 Duration [min]'], color='red')
plt.title('Cycle Number vs Ramp Duration - with 1 Heat Ramp', fontsize=10)
plt.ylabel('Ramp 1 Duration [min]', fontsize=10)
plt.xlabel('Cycle Number', fontsize=10)
plt.grid(True)
plt.show()
plt.tight_layout()
plt.savefig('Heat Ramp 1 - Plots/Cycle Number vs Ramp Duration  - with 1 Heat Ramp.png', dpi = 300)
# Temp. Dwell
plt.figure(figsize=(6.5,4))
plt.scatter( ASC_2021_data_X['Cycle Number'],ASC_2021_data_X['Temperature Dwell 1 [min]'], color='red')
plt.title('Cycle Number vs Temperature Dwell - with 1 Heat Ramp', fontsize=10)
plt.ylabel('Temperature Dwell 1 [min]', fontsize=10)
plt.xlabel('Cycle Number', fontsize=10)
plt.grid(True)
plt.show()
plt.tight_layout()
plt.savefig('Heat Ramp 1 - Plots/Cycle Number vs Temperature Dwell - with 1 Heat Ramp.png', dpi = 300)
# Vacuum Pressure
plt.figure(figsize=(6.5,4))
plt.scatter( ASC_2021_data_X['Cycle Number'],ASC_2021_data_X['Vacuum Pressure (*Patm) [Pa]'], color='red')
plt.title('Cycle Number vs Vacuum Pressure - with 1 Heat Ramp', fontsize=10)
plt.ylabel('Vacuum Pressure (*Patm) [Pa]', fontsize=10)
plt.xlabel('Cycle Number', fontsize=10)
plt.grid(True)
plt.show()
plt.tight_layout()
plt.savefig('Heat Ramp 1 - Plots/Cycle Number vs Vacuum Pressure - with 1 Heat Ramp.png', dpi = 300)
# Vacuum Start Time
plt.figure(figsize=(6.5,4))
plt.scatter( ASC_2021_data_X['Cycle Number'],ASC_2021_data_X['Vacuum Start Time [min]'], color='red')
plt.title('Cycle Number vs Vacuum Start Time - with 1 Heat Ramp', fontsize=10)
plt.ylabel('Vacuum Start Time [min]', fontsize=10)
plt.xlabel('Cycle Number', fontsize=10)
plt.grid(True)
plt.show()
plt.tight_layout()
plt.savefig('Heat Ramp 1 - Plots/Cycle Number vs Vacuum Start Time - with 1 Heat Ramp.png', dpi = 300)
#Vacuum Duration
plt.figure(figsize=(6.5,4))
plt.scatter( ASC_2021_data_X['Cycle Number'],ASC_2021_data_X['Vacuum Duration [min]'], color='red')
plt.title('Cycle Number vs Vacuum Duration - with 1 Heat Ramp', fontsize=10)
plt.ylabel('Vacuum Duration [min]', fontsize=10)
plt.xlabel('Cycle Number', fontsize=10)
plt.grid(True)
plt.show()
plt.tight_layout()
plt.savefig('Heat Ramp 1 - Plots/Cycle Number vs Vacuum Duration - with 1 Heat Ramp.png', dpi = 300)
#Autoclave Pressure
plt.figure(figsize=(6.5,4))
plt.scatter( ASC_2021_data_X['Cycle Number'],ASC_2021_data_X['Autoclave Pressure (*Patm) [Pa]'], color='red')
plt.title('Cycle Number vs Autoclave Pressure- with 1 Heat Ramp', fontsize=10)
plt.ylabel('Autoclave Pressure (*Patm) [Pa]', fontsize=10)
plt.xlabel('Cycle Number', fontsize=10)
plt.grid(True)
plt.show()
plt.tight_layout()
plt.savefig('Heat Ramp 1 - Plots/Cycle Number vs Autoclave Pressure - with 1 Heat Ramp.png', dpi = 300)
# Autoclave Start Time
plt.figure(figsize=(6.5,4))
plt.scatter( ASC_2021_data_X['Cycle Number'],ASC_2021_data_X['Autoclave Start Time [min]'], color='red')
plt.title('Cycle Number vs Autoclave Start Time - with 1 Heat Ramp', fontsize=10)
plt.ylabel('Autoclave Start Time [min]', fontsize=10)
plt.xlabel('Cycle Number', fontsize=10)
plt.grid(True)
plt.show()
plt.tight_layout()
plt.savefig('Heat Ramp 1 - Plots/Cycle Number vs Autoclave Start Time - with 1 Heat Ramp.png', dpi = 300)
#Autoclave Duration
plt.figure(figsize=(6.5,4))
plt.scatter( ASC_2021_data_X['Cycle Number'],ASC_2021_data_X['Autoclave Duration [min]'], color='red')
plt.title('Cycle Number vs Autoclave Duration - with 1 Heat Ramp', fontsize=10)
plt.ylabel('Autoclave Duration [min]', fontsize=10)
plt.xlabel('Cycle Number', fontsize=10)
plt.grid(True)
plt.show()
plt.tight_layout()
plt.savefig('Heat Ramp 1 - Plots/Cycle Number vs Autoclave Duration - with 1 Heat Ramp.png', dpi = 300)
#%% Dependent Variables
#Adhesive Porosity
plt.figure(figsize=(6.5,4))
plt.scatter( ASC_2021_data_X['Cycle Number'],ASC_2021_data_y['AD. Porosity (%)'], color='red')
plt.title('Cycle Number vs AD. Porosity - with 1 Heat Ramp', fontsize=10)
plt.ylabel('AD. Porosity (%)', fontsize=10)
plt.xlabel('Cycle Number', fontsize=10)
plt.grid(True)
plt.show()
plt.tight_layout()
plt.savefig('Heat Ramp 1 - Plots/Cycle Number vs AD. Porosity - with 1 Heat Ramp.png', dpi = 300)
#Prepreg Porosity
plt.figure(figsize=(6.5,4))
plt.scatter( ASC_2021_data_X['Cycle Number'],ASC_2021_data_y['PR. Porosity (%)'], color='red')
plt.title('Cycle Number vs PR. Porosity - with 1 Heat Ramp', fontsize=10)
plt.ylabel('PR. Porosity (%)', fontsize=10)
plt.xlabel('Cycle Number', fontsize=10)
plt.grid(True)
plt.show()
plt.tight_layout()
plt.savefig('Heat Ramp 1 - Plots/Cycle Number vs PR. Porosity - with 1 Heat Ramp.png', dpi = 300)
#Effective Porosity
plt.figure(figsize=(6.5,4))
plt.scatter( ASC_2021_data_X['Cycle Number'],ASC_2021_data_y['Eff. Porosity (%)'], color='red')
plt.title('Cycle Number vs Eff. Porosity - with 1 Heat Ramp', fontsize=10)
plt.ylabel('Eff. Porosity (%)', fontsize=10)
plt.xlabel('Cycle Number', fontsize=10)
plt.grid(True)
plt.show()
plt.tight_layout()
plt.savefig('Heat Ramp 1 - Plots/Cycle Number vs Eff. Porosity - with 1 Heat Ramp.png', dpi = 300)
#Max. Vf
plt.figure(figsize=(6.5,4))
plt.scatter( ASC_2021_data_X['Cycle Number'],ASC_2021_data_y['Max (Fiber Volume Fraction) (%)'], color='red')
plt.title('Cycle Number vs Max (Fiber Volume Fraction) - with 1 Heat Ramp', fontsize=10)
plt.ylabel('Max (Fiber Volume Fraction) (%))', fontsize=10)
plt.xlabel('Cycle Number', fontsize=10)
plt.grid(True)
plt.show()
plt.tight_layout()
plt.savefig('Heat Ramp 1 - Plots/Cycle Number vs Max Vf - with 1 Heat Ramp.png', dpi = 300)
#Cure Cycle Time
plt.figure(figsize=(6.5,4))
plt.scatter( ASC_2021_data_X['Cycle Number'],ASC_2021_data_y['Cure Cycle Total Time [min]'], color='red')
plt.title('Cycle Number vs Cure Cycle Total Time  - with 1 Heat Ramp', fontsize=10)
plt.ylabel('Cure Cycle Total Time [min]', fontsize=10)
plt.xlabel('Cycle Number', fontsize=10)
plt.grid(True)
plt.show()
plt.tight_layout()
plt.savefig('Heat Ramp 1 - Plots/Cycle Number vs Cure Cycle Time - with 1 Heat Ramp.png', dpi = 300)
#PR. Volume
plt.figure(figsize=(6.5,4))
plt.scatter( ASC_2021_data_X['Cycle Number'],ASC_2021_data_y['PR. Volume [m^3]'], color='red')
plt.title('Cycle Number vs PR. Volume [m^3] - with 1 Heat Ramp', fontsize=10)
plt.ylabel('PR. Volume [$m^3$]', fontsize=10)
plt.xlabel('Cycle Number', fontsize=10)
plt.grid(True)
plt.show()
plt.tight_layout()
plt.savefig('Heat Ramp 1 - Plots/Cycle Number vs PR.Volume - with 1 Heat Ramp.png', dpi = 300)
