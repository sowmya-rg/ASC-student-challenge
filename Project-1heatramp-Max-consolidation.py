...
plt.figure()
ax = plt.axes(projection='3d')
ax.scatter3D(ASC_2021_data_X['Vacuum Pressure (*Patm) [Pa]'], ASC_2021_data_y['AD. Porosity (%)'],ASC_2021_data_y['PR. Porosity (%)'])
ax.set_xlabel('Vacuum Pressure'); ax.set_ylabel('AD. Porosity (%)'); ax.set_zlabel('PR. Porosity (%)')
plt.title('PR Porosity vs AD Porosity and Vaccuum Pressure - with 1 Heat Ramp', fontsize=14)
plt.grid(True)
plt.show()
plt.tight_layout()
